...
const buscarPalabrasRelacionadas = (texto) => {
  ...
  // Iterar sobre cada entrada en el diccionario de emoticonos
  Object.entries(emoticonos).forEach(([emoji, palabras]) => {
    // Iterar sobre cada palabra asociada al emoji
    palabras.forEach(palabra => {
      // Construir una expresión regular que coincida con la palabra completa
      const regex = new RegExp("\\b" + palabra + "\\b", "gi");

      // Reemplazar la palabra completa en el texto por la palabra seguida del emoji
      textoModificado = textoModificado.replace(regex, `${palabra} ${emoji}`);
    });
  });
...
return (
  <div className="app-container">
    ...
    <div className="titulo-imagen-container">
      <img src={img1} alt="Titulo de la página" className="titulo-imagen" />
    </div>

    {/* Contenedor del texto emoticonos */}
    <div className="emoticonos-container">
    ...
    <div className="pdf-container">
      ...
      <div className="pdf-result-container">
        {/* Aquí mostraremos el resultado del PDF */}
